...
test("a legal page renders its title and the launch-gate notice until content is authored", async ({
  page,
}) => {
...
test("the products mega-menu source (ribbon) and product page agree on a product", async ({
  page,
}) => {
