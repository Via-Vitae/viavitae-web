...
test.each(['/lt', '/en', '/ru'])('the %s homepage renders a translated H1', async ({ page }, path) => {
...
test('the language switcher offers LT/EN/RU live and marks PL/DE as coming soon', async ({ page }) => {
  await page.goto('/en');
