...
export const TIERS: Readonly<Record<TierId, Tier>> = {
  economy: { id: 'economy', priceEur: 900, nameKey: 'tiers.economy.name', summaryKey: 'tiers.economy.summary' },
  normal: { id: 'normal', priceEur: 1900, nameKey: 'tiers.normal.name', summaryKey: 'tiers.normal.summary' },
...
const paid = (id: ProductId, demoType: string, nameKeySuffix: string, handlesPayments = false): Product => ({
  id,
  slug: id,
...
const ALL_CONTACT_CHANNELS: readonly ContactChannel[] = [
  ...
  { id: 'support', labelKey: 'contact.support', value: env('NEXT_PUBLIC_SUPPORT_EMAIL'), kind: 'email' },
  { id: 'security', labelKey: 'contact.security', value: 'security@viavitae.com', kind: 'email' },
  { id: 'phone', labelKey: 'contact.phone', value: env('NEXT_PUBLIC_SUPPORT_PHONE'), kind: 'phone' },
