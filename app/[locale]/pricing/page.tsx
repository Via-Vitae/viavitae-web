  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-12 px-4 py-16">
      ...
      <section aria-labelledby="tiers-heading">
        <h2 id="tiers-heading" className="text-heading-2 text-text-primary">
      ...
      <section aria-labelledby="calc-heading">
        <h2 id="calc-heading" className="text-heading-2 text-text-primary">
          {t("pricing.calculatorHeading")}
        </h2>
        <div className="mt-6">
          <QuoteCalculator />
        </div>
