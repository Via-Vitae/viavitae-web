      ...
      {doc ? (
        <>
          <p className="text-body-sm text-text-muted">
            {t("legal.version", { version: doc.frontMatter.version })} ·{" "}
            {t("legal.effective", { date: doc.frontMatter.effectiveDate })}
          </p>
        ...
        <p
          role="note"
          className="rounded-md border border-state-warning bg-state-warning-tint p-6 text-body-md text-text-primary"
        >
